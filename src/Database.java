 ...
 * 
 * A idéia para a geração dos valores é determinar um valor inicial para cada opção (infectados, mortos, etc...)
 * e, além disso, gerar uma taxa máxima de crescimento para cada estado, e então a partir dai gerar os valores 
 * se baseando no valor anterior acrescido por uma taxa de crescimento randômica e limitada pela taxa de crescimento
 * máximo.
 */

public class Database {
	
	public int getDias() { // retorna o número de dias passados que os dados serão observados
		return 50;
	}
	
	Random rd = new Random();
	
	// Vetores com valores auxiliares para a geração dos dados fictícios a serem usados
	...
	// retorna um vetor com valores fictícios do número de infectados (acumulado) de um determinado estado para uma quantidade respectiva de dias
	...
	// retorna um vetor com valores fictícios do número de mortos (acumulado) de um determinado estado para uma quantidade respectiva de dias
	...
	// retorna um vetor com valores fictícios do número de recuperados (acumulado) de um determinado estado para uma quantidade respectiva de dias
	...
	// retorna um vetor com valores fictícios do número de vacinados (acumulado) de um determinado estado para uma quantidade respectiva de dias
	...
	// retorna um vetor com valores fictícios da data de vacinação para cada respectivo grupo prioritário de um determinado estado
	public int[] getDataVacina(int id) {
		int[] res = new int[6];
		int ini = data_vacina[id];
		for(int groups = 1; groups <= 5; groups++) { // percorre os grupos prioritários
			res[groups] = ini;
	...
	// retorna um vetor de Strings com notícias fictícias sobre a pandemia em um determinado estado
